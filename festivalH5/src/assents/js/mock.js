    ...
    var Random = function() {
        ...
        Random.extend({
            ...
            chineseName: function(count) {
                var familyNames = "璧甸挶瀛欐潕鍛ㄥ惔閮戠帇鍐檲瑜氬崼钂嬫矆闊╂潹鏈辩Е灏よ浣曞悤鏂藉紶瀛旀浌涓ュ崕閲戦瓘闄跺鎴氳阿閭瑰柣鏌忔按绐︾珷浜戣嫃娼樿憶濂氳寖褰儙椴侀煢鏄岄┈鑻楀嚖鑺辨柟淇炰换琚佹煶閰嗛矋鍙插攼".split("");
                var names = "璐电鐢熼緳鍏冨叏鍥借儨瀛︾ゥ鎵嶅彂姝︽柊鍒╂竻椋炲浆瀵岄『淇″瓙鏉版稕鏄屾垚搴锋槦鍏夊ぉ杈惧畨宀╀腑鑼傝繘鏋楁湁鍧氬拰褰崥缁嶅姛鏉惧杽鍘氬簡纾婃皯鍙嬭娌冲摬姹熻秴娴╀寒鏀胯唉浜ㄥ鍥轰箣杞堪鏈椾集瀹忚█鑻ラ福鏈嬫枌姊佹爧缁村惎鍏嬩鸡缈旀棴楣忔湀鑾哄獩鑹崇憺鍑′匠鍢夌惣鍕ょ弽璐炶帀妗傚ǎ鍙剁挧鐠愬▍鐞︽櫠濡嶈寽绉嬬強鑾庨敠榛涢潚鍊╁┓濮ｅ濞寸懢棰栭湶鐟舵€″┑闆佽摀".split("");
